...
- TUI config screen integration can be deferred.
 - Built-in theme options (dark-only): `catppuccin_mocha`, `neon`, `candy_land_pink`, `dracula`, `nord`, `gruvbox_dark`, `tokyo_night`, `one_dark`, `solarized_dark`, `monokai`, `everforest_dark`, `rose_pine`.
