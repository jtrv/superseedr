...
Project Lead to confirm priorities; remove `(UNCONFIRMED)`, once the action/ deliverable Phase has been confirmed. See https://github.com/Jagalite/superseedr/issues/153
