...
class IntegrationTestRunner:
    ...
    def __init__(self, compose_file: str = "docker-compose.yml"):
        ...
        self.transmission_config = self.data_dir / "transmission_config"
        self.transmission_downloads = self.data_dir / "transmission_downloads"
        self.transmission_watch = self.data_dir / "transmission_watch"
        
        self.qbittorrent = QBittorrentClient("http://localhost:8080")
        self.transmission = TransmissionClient("http://localhost:9091")
    ...
    def setup(self):
        ...
        dirs_to_clean = [
            ...
            self.transmission_downloads,
            self.transmission_watch,
        ]
    ...
    def save_artifacts(self, test_name: str):
        ...
        for service in ["tracker", "qbittorrent", "transmission"]:
