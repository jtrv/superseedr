...
# --- Magnet URI Handling ---
# Check if CFBundleURLTypes exists; if not, add it before the last </dict>
...
# Add CFBundleDocumentTypes for .torrent files
...
# The main app is Superseedr.app, the helper app is superseedr_handler.app
create-dmg \
